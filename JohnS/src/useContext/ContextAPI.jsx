...
//this provides us a Provider (distributor) and a Consumer (the component which wants the data) -> this is replaced by useContext

const ContextAPI = () => {
  const [people, setPeople] = React.useState(dataMain);
  const removeData = function (idParam) {
    return setPeople(function (item) {
